  ...
  return (
    <main className="min-h-screen flex items-center justify-center bg-surface p-4">
      <div className="card-neo max-w-xs w-full relative bg-surface-container-lowest">
        <div className="absolute -top-3 -left-3 badge-neo bg-primary-container px-3 py-0.5 text-[8px]">
          {isLogin ? "RETURNING CURATOR" : "NEW TALENT"}
        </div>
        
        <header className="mb-6 text-center">
          <h1 className="text-2xl uppercase mb-1">
            {isLogin ? "Curator Login" : "Join the Collective"}
          </h1>
          <p className="font-headline font-black text-[8px] uppercase tracking-[0.15em] opacity-50">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          {!isLogin && (
            <div>
              <label className="font-headline font-black text-[9px] uppercase mb-1 block tracking-widest">Identify Yourself</label>
              <input 
                type="text" 
          ...
          <div>
            <label className="font-headline font-black text-[9px] uppercase mb-1 block tracking-widest">Digital Coordinates</label>
            <input 
              type="email" 
          ...
          <button 
            type="submit" 
            className="btn-neo-primary w-full text-base py-3 shadow-[4px_4px_0px_0px_rgba(48,52,44,1)] active:shadow-none" 
            disabled={isLoading}
          >
          ...
          <div className="border-t-[2px] border-on-surface border-dashed pt-4">
            <p className="text-center font-headline font-black text-[8px] uppercase">
              ...
              <button 
                ...
                className="bg-primary-container px-2 py-0.5 neo-border shadow-[2px_2px_0px_0px_rgba(48,52,44,1)] hover:shadow-none hover:translate-x-[1px] hover:translate-y-[1px] transition-all"
              >
